...
export const miniappConfig = {
  accountAssociation: {
    header: "eyJmaWQiOjI0MzI3NDQsInR5cGUiOiJjdXN0b2R5Iiwia2V5IjoiMHhGOEU0RDRFYzNGMThFMWQwREIwMjNGNjVFN2JiNzA0NWY2RjM5NDdkIn0",
    payload: "eyJkb21haW4iOiJibG9jay1wdXp6bGUtYWxwaGEudmVyY2VsLmFwcCJ9",
    signature: "qx5zAp7g/5nPMuIra/q8uf4IHAxbY/G+ay/cAeNQuCk7xob0m8bpCQXPi+3znLp2Smc4z99fdGSrSabdA2BqVhw=",
  },
  miniapp: {
    version: "1",
    name: "Block Puzzle",
